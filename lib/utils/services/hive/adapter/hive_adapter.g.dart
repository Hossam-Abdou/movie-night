...
class HiveRateAdapter extends TypeAdapter<HiveRate> {
  @override
  final int typeId = 3;

  @override
  HiveRate read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, HiveRate obj) {
    writer
      ..writeByte(5)
      ..writeByte(0)
      ..write(obj.title)
